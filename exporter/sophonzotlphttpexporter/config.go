...
// Config defines configuration for the SOPHONZ OTLP/HTTP exporter.
type Config struct {
	...
	// Enabled toggles the exporter. When false (default), pushTraces/pushLogs
	// short-circuit and drop the data without sending.
